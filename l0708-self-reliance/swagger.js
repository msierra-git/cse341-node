...
const doc = {
   info: {
      ...
      description:
         'Tracks all self-reliance course details in the stakes, like the name of course, facilitator and where and when the class is held.<br>This also uses an Auth0 authorization for changing the data collection. Click here to <a href="https://sierra341-07.onrender.com/login" target="_blank">login</a> or click here to <a href="https://sierra341-07.onrender.com/logout" target="_blank">logout</a>.',
      version: '1.0.0',
      contact: {
